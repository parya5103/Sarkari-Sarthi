...
function sanitizeURL(url) {
    ...
    try {
        ...
        // If it's not a valid URL (e.g., relative path), return it as is
        // or return '#' depending on strictness. Returning URL here but ensuring it doesn't start with dangerous protocols
