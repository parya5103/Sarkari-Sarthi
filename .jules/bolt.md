...
## 2026-05-18 - Pre-compiling backend Regex\n**Learning:** Compiling complex regex dynamically inside of functions called in tight loops for data scraping causes unnecessary overhead and slows down parsing.\n**Action:** Move regexes out of functions to module scope and compile them using `re.compile()` to avoid repetitive compilation cost.
